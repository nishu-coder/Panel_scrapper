# github : https://github.com/nishu_coder
...
def slowprint(me):
    for u in me + '\n' :
        ...
        sys.stdout.flush()
        time.sleep(10 / 1000)
slowprint("[!] Great Powers Brings Great Responsibilities ............ ")
slowprint('''
\033[96m
+=========================================+
|.........ADMIN PANEL FINDER ..........|
...
|.....illegal use of this program !...... |
|# Mark my words.. Jai Hind !!            |
+=========================================+
|.........ADMIN PANEL FINDER...........|
+=========================================+
''')
print(" \033[95m ]==> YOU MUST WRITE PROTOCOLE : " +"  "+ "\n\t[+] HTTPS://" +"  "+"\n\t[+] HTTP://")
print(" [+] Eg : http://www.xyz.com \n [+] Eg : https://www.ex.com\n\n") 
print(" \033[95m ]==> YOU MUST WRITE [ / ] AT THE END OF THE SITE" + "\n\n\t[+] Eg : www.example.com/")
print("                                                                       ")
...
u = ('admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for miss in u :
    l = url+miss
    try :
        openurl = urllib.request.urlopen(l)
        print("_____________________________________________________________")
        print("                                                             ")
        print("\033[92m :::: ALERTE::: ADMIN PAGE ITS FOUND ::: "+l)
        print("_____________________________________________________________")
    except urllib.error.URLError as msg :
        print ("\033[91m **** SORRY NOT FOUND ::: "+l)


print ("----------------------------------------------------------------------------------------")
print ("\033[93m     I HOPE I HAVE HELPED YOU ^_^ , Thank YOU FOR Using MY SCRIPT -A.....-")
print ("----------------------------------------------------------------------------------------")
